let data = [
    ...
    {value: '周杰伦的听爸爸的话', time: 2, color: 'pink', speed: 2,fontSize: 25},
    {value: '周杰伦的听爷爷的话', time: 3, speed: 3,fontSize: 30},
]
...
class Barrage {
    ...
    init() {
        ...
        this.color = this.obj.color ||this.content.color;
        this.speed = this.obj.speed ||this.content.speed;
        this.opacity = this.obj.opacity ||this.content.opacity;
        this.fontSize = this.obj.fontSize ||this.content.fontSize;

        // 为了计算每个弹幕的宽度，我们来创建一个元素P然后计算文字的宽度
