...
export const SET_CURRENT_INDEX = 'SET_CURRENT_INDEX' // 设置播放页面的索引
export const SET_PLAYING = 'SET_PLAYING' 
export const SAVE_PLAY_HISTORY = 'SAVE_PLAY_HISTORY'  //保存已播放的歌曲
export const SAVE_FAVORITE_LIST = 'SAVE_PLAY_HISTORY'  //保存最喜欢的歌曲